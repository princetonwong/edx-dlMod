...
def getJson2(group_id,try_num):
    ...
    while x<try_num:
        ...
        # get_json = session.get("https://wx.zsxq.com/dweb2/index/group/{}/topics?scope=all&count=20".format(group_id),
...
if __name__ == '__main__':
    ...
    cookies = {
        'abtest_env': 'product',
        'zsxq_access_token': '4D651232-46E2-E945-E1CA-C55E49F84B32_6D9EDEC4706EF1A9' #token值
    }
    for i in range(getJson2("15284842455212",10)):#getJson2(https://wx.zsxq.com/dweb2/index/group/后面的数字,重复请求次数)
        mkDocx(i+1)
