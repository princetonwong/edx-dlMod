...
ZSXQ_ACCESS_TOKEN = '4D651232-46E2-E945-E1CA-C55E49F84B32_6D9EDEC4706EF1A9'    # 登录后Cookie中的Token（必须修改）
USER_AGENT = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.2 Safari/605.1.15'    # 登录时使用的User-Agent（必须修改）
GROUP_ID = '15284842455212'                         # 知识星球中的小组ID
...
if __name__ == '__main__':
    ...
    if ONLY_DIGESTS:
        ...
        # start_url = 'https://wx.zsxq.com/dweb2/index/group/' + GROUP_ID + '/topics?scope=digests&count=' + str(
        #     COUNTS_PER_TIME)
    else:
        start_url = 'https://api.zsxq.com/v2/groups/' + GROUP_ID + '/topics?count=' + str(COUNTS_PER_TIME)
        # start_url = 'https://wx.zsxq.com/dweb2/index/group/' + GROUP_ID + '/topics?count=' + str(COUNTS_PER_TIME)
